...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *HwMgmtDefaults) DeepCopyInto(out *HwMgmtDefaults) {
	*out = *in
	if in.NodeGroupData != nil {
		in, out := &in.NodeGroupData, &out.NodeGroupData
		*out = make([]hardwaremanagementv1alpha1.NodeGroupData, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new HwMgmtDefaults.
func (in *HwMgmtDefaults) DeepCopy() *HwMgmtDefaults {
	if in == nil {
		return nil
	}
	out := new(HwMgmtDefaults)
	in.DeepCopyInto(out)
	return out
}
...
func (in *Templates) DeepCopyInto(out *Templates) {
	*out = *in
	in.HwMgmtDefaults.DeepCopyInto(&out.HwMgmtDefaults)
}
